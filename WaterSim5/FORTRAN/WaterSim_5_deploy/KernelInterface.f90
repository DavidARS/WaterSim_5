...
! Created on 06.07.10
!
! Last modified on 10.17.13,07.21.14,11.03.17
! -------------------------------------------
!
...
subroutine setDemandPercent(value)
   ...
   gvi_ReductionDemand_pctOfBaseline=value
 return
end subroutine
function getDemandPercent() result(value)
   ...
   value = gvi_ReductionDemand_pctOfBaseline
...
subroutine getNormalFlowEmpiricalMax(count, values)
   use lms_ParameterControl
    ...
    !
    count=10
    forall(i=1:count) values(i)=gvi_NormalFlowEmpiricalMax_acftac(i)
 return
end subroutine
subroutine setNormalFlowEmpiricalMax(count, values)
   use lms_ParameterControl
    ...
    !
    forall(i=1:count) gvi_NormalFlowEmpiricalMax_acftac(i)=generic(i)
 return
end subroutine
!
!            -----------------------------------
...
! =====================================================================================
! -------------------------------------------------------------------------------------
!                    WaterSim 6 functions and subroutines
!!
!                   NOTE: NOT USED in WaterSim 5.9.9
!
!                   Last write: 11.03.17
!
...
!
!               Functions and subroutines ablve had parameters set in the
!           WaterSimDCDC.txt file, so I will leave them as is. The following
!           Calls are NOT connected to anything in the WaterSim 5 model
!
!           Last write: 11.03.17
!
! =====================================================================================================
