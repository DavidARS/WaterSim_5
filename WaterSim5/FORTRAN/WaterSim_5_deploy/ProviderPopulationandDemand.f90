...
!            E%MySub='calcDemand'
    ...
    !               lvf_providerPopulations=gvf_population
               ...
               do i = 1,gvi_Providers,1
                ...
                if(0 == gvi_ReductionDemand_pctOfBaseline)gvi_ReductionDemand_pctOfBaseline = 1.
                 ...
                 ! Read Demand from files
                  do i = gpi_minPVY,gpi_maxPVY-1,1
                    do j = 1,gvi_Providers,1
                      ...
                      lvd_providerDemandRandM(i,j)= lvd_providerDemand(i,j)*gvi_ReductionDemand_pctOfBaseline
                      !
                    end do
                  end do
...
10 format(I4,1x,F7.2,2x,3(F5.0,1x))
                    ! ====================================================================================
...
!
    ...
    function fOutDoorEstimate(pop,demand,days,bwProp)
        ...
        ! ==========================================
            !
            lvf_BWtypical_acft= pop*(lpf_gallonsPerFlush*lpf_flushesPerDay*days)*1/gpd_galperacft
            ! 
            if(0. < demand)then
              if(0 < bwProp)then
           ...
           ! real,parameter :: lvc_AcresToSqMeters=4046.8564224
            ...
            !
                ...
                call ProviderArea2012(vArea)
                  ...
                  vArea2012(i)=0
                ! 05.24.16 - this was the old code
                ! vArea2012(i)=lvc_AcresToSqMeters* (lid_providerAcres(i,1) + lid_providerAcres(i,2)) 
