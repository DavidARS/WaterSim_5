    ...
    Module gm_TypeControl
      use gm_GlobalData
       ...
       type RiverA
        ...
        !
        real :: gvf_verdeToSaltTransferClassA_acft,gvf_verdeToSaltTransferClassBC_acft
        ...
        !
        real :: gvf_classAVerdeToSaltMonthly_acft(12),gvf_classBCVerdeToSaltMonthly_acft(12)
        !
       ...
       type Surfacewater
        ...
        type Provider
         ...
         !
         ! annual time-step ---------------------------------------
         real :: lvf_cDemand_Res_outdoor_acft_annual(gvi_maxProV)
         real :: lvf_cDemand_Res_indoor_acft_annual(gvi_maxProV)
         !
         real :: lvf_cDemand_Ind_outdoor_acft_annual(gvi_maxProV)
         real :: lvf_cDemand_Ind_indoor_acft_annual(gvi_maxProV)
         !
         real :: lvf_cDemand_Com_outdoor_acft_annual(gvi_maxProV)
         real :: lvf_cDemand_Com_indoor_acft_annual(gvi_maxProV)
         ...
         real :: gvf_pMunicipalPumping_acft_monthly(gvi_maxProV,12)
     
         real :: gvf_pAddToSRPrelease(gvi_maxProV)
         !
         real :: cPopProvider(gvi_maxProV)
         real :: lvf_newWaterSupplies_acft_annual(gvi_maxProV)
         ! 
     ...
     !
        ...
        type SalinityWB
          ...
          real :: gvf_sMuniPumpingtoTDS_acft(gvi_maxProV,12), gvf_sMuniPumpingTreatedtoTDS_acft(gvi_maxProV,12)
