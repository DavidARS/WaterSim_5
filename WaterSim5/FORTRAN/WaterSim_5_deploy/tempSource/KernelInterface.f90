...
function getAgProductionPCT() result(value)
  use lms_AgWaterBudgets
    ...
    value=go_AgWaterUsedByMuni_PCT_a
end function
! ==============
!subroutine getAgWaterToPotential_PCT(count, values)
!   use lms_Provider
!    implicit none
!    dll_export ::  getAgWaterToPotential_PCT
!    integer :: count,i
!    integer, dimension(1:count) :: values
!    ! 
!    forall(i=1:count) values(i)= (i)
! return
!end subroutine
! DAS 04.06.15
!
...
subroutine getGrayWaterResidential(count, values)
   use lms_CitiWaterBudgets
    ...
    integer, dimension(1:count) :: values
    ! 
    forall(i=1:count) values(i)= go_GrayWaterReclaimed_acft(i,1) 
 return
end subroutine
! ===========================================================
! 
...
subroutine getGrayWaterCommercial(count, values)
   use lms_CitiWaterBudgets
    ...
    integer, dimension(1:count) :: values
    ! 
    forall(i=1:count) values(i)= go_GrayWaterReclaimed_acft(i,2) 
 return
end subroutine
! ===========================================================
! 
...
subroutine getGrayWaterIndustrial(count, values)
   use lms_CitiWaterBudgets
    ...
    integer, dimension(1:count) :: values
    ! 
    forall(i=1:count) values(i)= go_GrayWaterReclaimed_acft(i,3) 
 return
end subroutine
! ===========================================================
! 
