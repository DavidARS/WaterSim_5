            ...
            if(gvl_start)then
              if(lvl_firstLoop)then             
                ...
                if(lvl_firstLoop)then
                    ...
                    ! -------------------------------------------------------------------------
                    !
                    ! go_pumpingAgTotal_AF(T%year-1) added on 01.22.2017
                    !
                    ...
                    out=out+lvf_outFlowTotal_acft+lvf_otherPumping_acft &
                      + lvf_regionalOutflows+go_pumpingAgTotal_AF(T%year)
...
300 format(I4,1x,I2,1x,5(F12.2,1x),1x,I4,2x,F12.0) 
301 format(I4,1x,3(F12.2))
          ! -----------------------------------------------------------------------------------------
          !
...
3 format(I4,1x,3(F10.2,1x))
        ...
        subroutine sAgriculture(T,lvWB,i,vTstep)
           ...
           ! =======================
            ...
            !
310 format(I4,1x,I2,1x,1(F12.2,1x))
         return
