    ...
    Subroutine sStrings(code,errorString)
        ...
        ! ===========================
            !
             ...
             if(code ==2)errorString=" Error: Provider Population and Demand-readFiles_pop "        
            ...
            !
             ...
             if(code ==61)errorString="  Open file error- Opening Default Parameters"
             if(code ==62)errorString="  Open file error- Reading Default Parameters-"
             if(code ==63)errorString="  Open file error- LandUseLandCover.f90"
             if(code ==64)errorString="  Open file error- LandUseLandCover.f90"
             !
